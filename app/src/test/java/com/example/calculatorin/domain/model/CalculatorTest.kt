...
class CalculatorTest {
    ...
    fun `test addition`() {
        ...
        result.getOrNull()?.let { assertEquals(5.0, it, 0.0) }
    }
    ...
    fun `test subtraction`() {
        ...
        assertTrue(result.isSuccess)
        result.getOrNull()?.let { assertEquals(2.0, it, 0.0) }
    }
    ...
    fun `test multiplication`() {
        ...
        assertTrue(result.isSuccess)
        result.getOrNull()?.let { assertEquals(12.0, it, 0.0) }
    }
    ...
    fun `test empty expression`() {
        ...
        assertTrue(result.isSuccess)
        result.getOrNull()?.let { assertEquals(0.0, it, 0.0) }
    }
    ...
    fun `test decimal numbers`() {
        ...
        assertTrue(result.isSuccess)
        result.getOrNull()?.let { assertEquals(6.0, it, 0.0) }
    }
} 